...
public class StudentPortalTestServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.isUserInRole("Sneha")){
                Students s1 = studentsService.findByUsername(request.getRemoteUser());
                out.println("<h3>Please find your details below</h3>");
                out.println("<h2> First Name: " + s1.getStudentFName() + "<br> " + 
                        "Last Name: " + s1.getStudentLName() + "<br>"+
                        "Email Address: " + s1.getStudentEmail() + "<br>"+
                        "Degree Type: " + s1.getStudentDegreeType() + "</h2>");
            }
